    ...
    <div className="flex flex-col md:flex-row gap-4 mb-6 items-start md:items-center">
      ...
      <div className="flex flex-wrap items-center gap-2 w-full md:w-auto">
        ...
        <select
          ...
          className="bg-gray-700/50 border border-gray-600/50 text-gray-300 text-sm rounded-lg focus:ring-cyan-500/50 focus:border-cyan-500 block p-3 transition-smooth shadow-sm"
        ...
        <div className="flex items-center gap-1 ml-auto md:ml-0">
          ...
          <button
            ...
            className="p-3 bg-gray-700/50 border border-gray-600/50 rounded-lg text-gray-300 hover:text-cyan-400 hover:border-cyan-500 transition-smooth shadow-sm"
