...
export function MarketingFooter() {
  return (
    <footer className="bg-gradient-to-br from-white to-gray-50 py-12 border-t border-gray-200/70">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-8">
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl font-black text-[#2f6978]">TODO <span className="text-[#42aec9]">APP</span></span>
          </div>
        ...
        <div className="text-center pt-8 border-t border-gray-200/50">
          <p className="text-gray-500 font-medium tracking-tight">
            © 2026 TODO <span className="text-[#42aec9]">APP</span>. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
