# Backend Security / Permissions Skill

## Purpose

To enforce security and permission policies on backend, including rate-limiting, XSS prevention, SQL injection prevention, JWT expiry checks, and user access control. This skill serves as the reasoning layer for all security-related decisions in FastAPI backend, ensuring robust protection against vulnerabilities, proper authentication and authorization, and comprehensive security logging.
...
1. Sanitize text input:
   ...
   - Use sanitization library (bleach, html5lib)
2. Sanitize URLs:
   - Validate URL format
...
5. Sanitize output:
   ...
   - Use template engine auto-escaping (Jinja2, etc.)
...
2. **Testing & QA Agents**
   - When testing security controls
   - When testing authentication and authorization
   - When testing XSS/SQL injection prevention
...
inputs:
  ...
  output_format: "security_decision"
```
