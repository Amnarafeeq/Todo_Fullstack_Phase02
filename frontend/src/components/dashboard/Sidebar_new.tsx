...
export function Sidebar({ isOpen, onClose, pathname }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed inset-y-0 left-0 z-50 w-64 bg-gray-900 border-r border-gray-700/50 backdrop-blur-xl
      ...
      >
        ...
        <div className="flex items-center justify-between h-16 px-4 border-b border-gray-700/50">
          <Link
            href="/dashboard"
            className="flex items-center gap-2 text-lg font-bold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent"
            onClick={onClose}
      ...
      <aside
        className="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:z-40 lg:w-64 lg:bg-gray-900/80 lg:border-r lg:border-gray-700/50 lg:flex lg:flex-col lg:backdrop-blur-xl"
        aria-label="Sidebar navigation"
      >
        ...
        <div className="flex items-center h-16 px-6 border-b border-gray-700/50">
          <Link
            href="/dashboard"
            className="flex items-center gap-2 text-xl font-bold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent"
            aria-label="TaskFlow - Dashboard"
          >
        ...
        <div className="p-4 border-t border-gray-700/50">
          <div className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-cyan-500/5 cursor-pointer transition-colors">
